...
class TestParseOutput:
    ...
    def test_data_length(self):
        data_elements = dispatcher.parse_output(tmp_string, 'm39', 0)[0]
        assert len(data_elements) == 6

    def test_data_extraction(self):
        data_elements = dispatcher.parse_output(tmp_string, 'm39', 1)[0]
        assert data_elements[0] == '170001 0.0327583 0 0.0005 3997 1e-10 1e-05 1e-06 2 4000 1'

    def test_header_configuration(self):
        header_element = dispatcher.parse_output(tmp_string, 'm39', 0)[1]
